...
final class WorkerMessageSkipEventSubscriber implements EventSubscriberInterface
{
    ...
    public function onSkipped(WorkerMessageSkipEvent $event): void
    {
        $this->contextBuilder->ensureUuidOnWorkerEvent($event);

        $this->logger?->log(
            $this->logLevel,
            'Messenger message skipped.',
    ...
    {
        return [
            WorkerMessageSkipEvent::class => 'onSkipped',
        ];
    }
}
